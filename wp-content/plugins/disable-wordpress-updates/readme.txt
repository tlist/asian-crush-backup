...
If you use this plugin, you must make sure you keep yourself up to date with new releases of your active wordpress version, plugins 
...
2. Copy the `disable-wordpress-updates` folder into `wp-content/plugins/` directory
...
= Where can I do to be up to date with new releases of my wordpress version, plugins and themes? =

Simply deativate the plugin for a short time. In case new versions are existing you see the wordpress notifications.
